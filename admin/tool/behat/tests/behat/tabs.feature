...
Feature: Confirm that we can open multiple browser tabs
  ...
  Scenario: Open multiple browser tabs
    ...
    # Open new tabs for specified pages, with or without quotes.
    And I open a tab named "CourseViewer2" on the "C3" "Course" page
    And I open a tab named CourseViewer3 on the C4 Course page

    # And for a specified page without identifier (these ones require quotes).
    ...
    And I switch to "CourseViewer3" tab
    Then I should see "Course 4" in the "h1" "css_element"
    And I switch to "CourseViewer2" tab
    Then I should see "Course 3" in the "h1" "css_element"
