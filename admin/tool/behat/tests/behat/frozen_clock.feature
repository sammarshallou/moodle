...
Feature: Frozen clock in Behat
  ...
  Background:
    ...
    And the following "activity" exists:
      | activity       | url                                                         |
      | externalurl    | #wwwroot#/admin/tool/behat/tests/fixtures/core/showtime.php |
      | course         | C1                                                          |
      | name           | Fixture                                                     |
    And the following "activity" exists:
      | activity | forum     |
  ...
  Scenario: Time has been frozen
    ...
    When the time is frozen at "2024-03-01 12:34:56"
    ...
    And I am on the "TestForum" "forum activity" page logged in as admin
  ...
  Scenario: Time is normal
    When the following "mod_forum > discussions" exist:
      | user  | forum  | name     | message  |
      | admin | forum1 | Subject1 | Message1 |
    And I am on the "TestForum" "forum activity" page logged in as admin
    Then I should not see "1 Aug 2024" in the "Subject1" "table_row"
    And I am on the "Fixture" "url activity" page
    Then I should see "Behat time is the same as real time"
  ...
  Scenario: Time is frozen and then unfrozen
    ...
    And I am on the "TestForum" "forum activity" page logged in as admin
    Then I should see "1 Mar 2024" in the "Subject1" "table_row"
    And I should not see "1 Mar 2024" in the "Subject2" "table_row"
    And I am on the "Fixture" "url activity" page
