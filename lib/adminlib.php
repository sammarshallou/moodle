...
/**
 * Admin setting class for encrypted values using private/public key encryption.
 *
...
class admin_setting_encryptedpassword extends admin_setting {
    ...
    public function write_setting($data) {
        ...
        if ($data === '') {
            ...
            $savedata = setting_encryption::encrypt($data);

            // Note this encryption could be done client-side for security, but assuming the server
            // is https, it already gets encrypted in transit anyway so that isn't 100% necessary,
