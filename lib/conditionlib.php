...
/**
 * CONDITION_MISSING_NOTHING - The $cmors variable is expected to contain all completion-related data
 */
define('CONDITION_MISSING_NOTHING', 0);
/**
 * CONDITION_MISSING_EXTRATABLE - The $cmors variable is expected to contain the fields from course_modules
