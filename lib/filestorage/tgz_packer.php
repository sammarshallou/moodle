...
class tgz_packer extends file_packer {
    ...
    protected function write_tar_entry($gz, $archivepath, $file, $size, $mtime, $content = null,
        ...
        //    char uid[8];
        //    char gid[8];
        $header .= "0000644\x000000000\x000000000\x00";
        ...
        //
        // '000064400000000000000        ustar00'
        // mode, uid, gid, checksum space, magic number, version
        //
        // To calculate the number, call the calculate_checksum function on the
        // above string. The result is 1933.
        $checksum = 1933 + self::calculate_checksum($forchecksum);
