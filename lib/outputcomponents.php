...
class user_picture implements renderable {
    ...
    public static function fields($tableprefix = '', array $extrafields = NULL, $idalias = 'id', $fieldprefix = '') {
        ...
        $userfields = new \core\user_fields([\core\user_fields::PURPOSE_USERPIC], $extrafields);
        ['selects' => $selects] = $userfields->get_sql(null, false, false,
                $tableprefix, $fieldprefix, $idalias);
        if ($tableprefix === '') {
