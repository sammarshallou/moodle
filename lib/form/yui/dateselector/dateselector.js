YUI.add('moodle-form-dateselector', function(Y) {
    ...
    M.form.dateselector = {
        ...
        /**
         * This function can be used after init to add date selector functionality
         * to dynamically-generated form fields. Call with a node that contains
         * fields named in the same format as the forms.
         *
         * @method init_single_date_selector
         * @param {Y.Node} node Parent node that contains required fields
         */
        init_single_date_selector : function(node) {
