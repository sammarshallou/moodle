...
/**
 * Event fired when a user's grade is created in the database by any means.
 *
 * @package core
 ...
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class grade_created extends base {
    ...
    public static function get_name() {
        return get_string('eventgradecreated', 'moodle');
    }

    public function get_description() {
        return "Grade {$this->objectid} created for user {$this->relateduserid}.";
    }
}
