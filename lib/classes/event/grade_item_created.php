...
/**
 * Event fired when a course grade item is created in the database by any means.
 *
 * @package core
...
class grade_item_created extends base {
    ...
    public static function get_name() {
        return get_string('eventgradeitemcreated', 'moodle');
    }

    public function get_description() {
        return "Grade item {$this->objectid} created.";
    }
}
