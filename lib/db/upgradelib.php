 ...
 * If we did, $groupmembersonly would be set to the groupmembersonly option
 * for the module. Since we don't, it will be set to 0 for modules, and 1
 * for sections if they have a grouping.
 *
