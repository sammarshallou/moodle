    ...
    if ($oldversion < 2014022800.05) {
        ...
        $cmcount = $DB->count_records_sql("
                SELECT COUNT(1)
                 ...
                 WHERE cm.groupmembersonly != 0 OR
                       cm.availablefrom != 0 OR
        ...
        $lastupdate = 0;
        $rs = $DB->get_recordset_sql("
                SELECT cm.id, cm.groupmembersonly, cm.groupingid, cm.availablefrom,
                       cm.availableuntil, cm.showavailability,
                 ...
                 WHERE cm.groupmembersonly != 0 OR
                       ...
                       cmf.id IS NOT NULL
              GROUP BY cm.id, cm.groupmembersonly, cm.groupingid, cm.availablefrom,
                       cm.availableuntil, cm.showavailability");
        foreach ($rs as $rec) {
            ...
            // Update item.
            $availability = upgrade_availability_item($rec->groupmembersonly,
