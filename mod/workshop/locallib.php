...
class workshop {
    ...
    public function get_submissions($authorid='all', $groupid=0, $limitfrom=0, $limitnum=0) {
        ...
        ['selects' => $authorfields] = $userfieldsapi->get_sql(null, false, false, 'u', 'author', 'authoridx', false);
        ['selects' => $gradeoverbyfields] = $userfieldsapi->get_sql(null, false, false, 't', 'over', 'gradeoverbyx', false);
        $params            = array('workshopid' => $this->id);
    ...
    public function get_submission_by_id($id) {
        ...
        $userfieldsapi = new \core\user_fields([\core\user_fields::PURPOSE_USERPIC]);
        ['selects' => $authorfields] = $userfieldsapi->get_sql(null, false, false, 'u', 'author', 'authoridx', false);
        ['selects' => $gradeoverbyfields] = $userfieldsapi->get_sql(null, false, false, 'g', 'gradeoverby', 'gradeoverbyx', false);
    ...
    public function get_all_assessments() {
        ...
        $userfieldsapi = new \core\user_fields([\core\user_fields::PURPOSE_USERPIC]);
        ['selects' => $reviewerfields] = $userfieldsapi->get_sql(null, false, false, 'reviewer', '', 'revieweridx', false);
        ['selects' => $authorfields] = $userfieldsapi->get_sql(null, false, false, 'author', 'author', 'authorid', false);
        ['selects' => $overbyfields] = $userfieldsapi->get_sql(null, false, false, 'overby', 'overby', 'gradinggradeoverbyx', false);
    ...
    public function get_assessment_by_id($id) {
        ...
        $userfieldsapi = new \core\user_fields([\core\user_fields::PURPOSE_USERPIC]);
        ['selects' => $reviewerfields] = $userfieldsapi->get_sql(null, false, false, 'reviewer', 'reviewer', 'revieweridx', false);
        ['selects' => $authorfields] = $userfieldsapi->get_sql(null, false, false, 'author', 'author', 'authorid', false);
        ['selects' => $overbyfields] = $userfieldsapi->get_sql(null, false, false, 'overby', 'overby', 'gradinggradeoverbyx', false);
    ...
    public function prepare_grading_report_data($userid, $groupid, $page, $perpage, $sortby, $sorthow) {
        ...
        if ($numofparticipants > 0) {
            ...
            $userfieldsapi = new \core\user_fields([\core\user_fields::PURPOSE_USERPIC]);
            ['selects' => $picturefields] = $userfieldsapi->get_sql(null, false, false, 'u', '', 'userid', false);
        ...
        $additionalnames = \core\user_fields::get_name_fields();
        ...
        if ($submissions) {
            ...
            $userfieldsapi = new \core\user_fields([\core\user_fields::PURPOSE_USERPIC]);
            ['selects' => $picturefields] = $userfieldsapi->get_sql(null, false, false, 'r', '', 'reviewerid', false);
        ...
        if ($participants) {
            ...
            $params['workshopid'] = $this->id;
            $userfieldsapi = new \core\user_fields([\core\user_fields::PURPOSE_USERPIC]);
            ['selects' => $picturefields] = $userfieldsapi->get_sql(null, false, false, 'e', '', 'authorid', false);
...
abstract class workshop_submission_base {
    ...
    public function anonymize() {
        $authorfields = explode(',', implode(',', \core\user_fields::get_picture_fields()));
