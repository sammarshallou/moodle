...
function glossary_get_recent_mod_activity(&$activities, &$index, $timestart, $courseid, $cmid, $userid = 0, $groupid = 0) {
    ...
    ['selects' => $ufields] = $userfieldsapi->get_sql(null, false, false, 'u', '', 'userid', false);
...
function glossary_print_recent_activity($course, $viewfullnames, $timestart) {
    ...
    $userfieldsapi = new \core\user_fields([\core\user_fields::PURPOSE_USERPIC]);
    ['selects' => $userfields] = $userfieldsapi->get_sql(null, false, false, 'u', '', 'userid', false);
...
function glossary_get_entries_by_search($glossary, $context, $query, $fullsearch, $order, $sort, $from, $limit,
    ...
    $userfieldsapi = new \core\user_fields([\core\user_fields::PURPOSE_USERPIC]);
    ['selects' => $userfields] = $userfieldsapi->get_sql(null, false, false, 'u', 'userdata', 'userdataid', false);
