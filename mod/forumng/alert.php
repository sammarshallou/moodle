...
$customdata = (object)array(
        ...
        'url' => $CFG->wwwroot . '/mod/forumng/discuss.php?' . $discussion->get_link_params(mod_forumng::PARAM_PLAIN) . '#p'.$postid
);
...
if ($mform->is_cancelled()) {
    redirect('discuss.php?' . $discussion->get_link_params(mod_forumng::PARAM_PLAIN) . '#p' . $postid);
}
