...
require_once($CFG->dirroot . '/mod/forumng/backup/moodle2/backup_forumng_stepslib.php'); // Because it exists (must)
require_once($CFG->dirroot . '/mod/forumng/backup/moodle2/backup_forumng_settingslib.php'); // Because it exists (optional)
...
class backup_forumng_activity_task extends backup_activity_task {
    ...
    protected function define_my_steps() {
        ...
        $this->add_step(new backup_forumng_activity_structure_step('forumng structure', 'forumng.xml'));
    }
