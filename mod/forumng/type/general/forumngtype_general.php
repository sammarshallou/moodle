...
class forumngtype_general extends forumngtype {
    ...
    public function print_view_page($forum, $groupid) {
        ...
        if (count($sticky) + count($normal) > 0) {
            ...
            foreach ($sticky as $discussion) {
                print $out->render_discussion_list_item($forum, $groupid);
            }
    ...
    public function print_discussion_page($discussion) {
        ...
        if ($showexpandall) {
            print '<a href="' .
                $discussion->get_url(mod_forumng::PARAM_HTML) . '&amp;expand=1' . $fakedate . '">' .
        ...
        if ($showcollapseall) {
            print '<a href="' . $discussion->get_url(mod_forumng::PARAM_HTML) . '&amp;collapse=1' . $fakedate .
