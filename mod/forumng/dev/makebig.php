...
print '<li>User/discussion read data: <strong>' . $DB->count_records('forumng_read') . '</strong></li>';
print '<li>User/forum subscriptions: <strong>' . $DB->count_records('forumng_subscriptions') . '</strong></li>';
print '<li>User/post ratings: <strong>' . $DB->count_records('forumng_ratings') . '</strong></li>';
print '</ul>';
...
show_maximum_per('Discussions per forum', 'forumng_discussions','forumngid','/mod/forumng/view.php?id=$$');
show_maximum_per('Subscriptions per forum', 'forumng_subscriptions','forumngid','/mod/forumng/view.php?id=$$');
