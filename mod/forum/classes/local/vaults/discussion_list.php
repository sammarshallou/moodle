...
class discussion_list extends db_table_vault {
    ...
    protected function generate_get_records_sql(string $wheresql = null, ?string $sortsql = null, ?int $userid = null) : string {
        ...
        $userfieldsapi = new \core\user_fields([\core\user_fields::PURPOSE_USERPIC], ['deleted']);
        ['selects' => $firstauthorfields] = $userfieldsapi->get_sql(null, false, false, 'fa',
                self::FIRST_AUTHOR_ALIAS, self::FIRST_AUTHOR_ID_ALIAS, false);
        ['selects' => $latestuserfields] = $userfieldsapi->get_sql(null, false, false, 'la',
                self::LATEST_AUTHOR_ALIAS, self::LATEST_AUTHOR_ID_ALIAS, false);
