...
class course_enrolment_manager {
    ...
    protected function get_basic_search_conditions($search, $searchanywhere) {
        ...
        // TODO Does not support custom profile fields.
        $userfields = new \core\user_fields([\core\user_fields::PURPOSE_IDENTITY], [], ['username', 'lastaccess']);
        $extracolumns = $userfields->get_required_fields($this->get_context(), false);
