...
//
// Location to store private and public keys. By default this is $CFG->dataroot/secret; set this if
...
// need to manually generate them by running 'php admin/cli/generate_keypair.php'.
