...
$string['searchalternatesettings'] = 'Alternate settings';
$string['searchalternatesettings_desc'] = 'These settings are only used when alternate settings are selected for the query-only search engine.';
