...
$string['task_disable_processing'] = 'Disable background tasks';
$string['task_disable_processing_desc'] = 'Prevents the system from starting new background tasks. (This option is intended for temporary use only, e.g. before a restart. Leaving it on for a long time will prevent important functionality from working.)';
