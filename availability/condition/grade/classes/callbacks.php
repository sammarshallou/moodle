...
/**
 * Callbacks handling grade changes (to clear cache). This ought to use the
 * hooks system, but it doesn't exist - calls are hard-coded. (The new event
 * system is not suitable for this type of use.)
 *
 * @package availability_grade
 * @copyright 2014 The Open University
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
